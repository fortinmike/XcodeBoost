...
- (id)testOperationForTestingSpecification:(id)arg1 executionEnvironment:(id)arg2 buildParameters:(id)arg3 runDestination:(id)arg4 workspace:(id)arg5 actionRecord:(id)arg6 schemeIdentifier:(id)arg7 outSchemeActionResultOperation:(id *)arg8 error:(id *)arg9 launchParametersBlock:(CDUnknownBlockType)arg10 actionCallbackBlock:(CDUnknownBlockType)arg11;
