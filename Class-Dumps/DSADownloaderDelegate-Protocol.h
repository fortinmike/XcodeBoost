...
@class DSADownloader, NSError, NSString, NSURLAuthenticationChallenge;
...
@optional
- (void)downloaderWillResumeDownload:(DSADownloader *)arg1;
- (void)downloader:(DSADownloader *)arg1 willDownloadFile:(NSString *)arg2 ofSize:(long long)arg3;
- (void)downloader:(DSADownloader *)arg1 needsCredentialForChallenge:(NSURLAuthenticationChallenge *)arg2 completionBlock:(void (^)(NSURLCredential *))arg3;
